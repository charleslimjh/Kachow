...
| 17 | Booking        | User can make a booking                               | 1\. Log in and go to Booking via Navbar<br>2\. Select the desired booking type through the 3 drop down menus<br>3\. Select the time and date<br>4\. Click confirm<br>                                    | User will be redirected to booking.html<br><br>User will see confirmation page upon submitting the category and date<br><br>New record will be displayed in Cloud Firestore                | Pass   |

...
| 9  | Telegram       | User can start conversation with Telegram bot         | 1\. Login and go to Account page<br>2\. Click on Link to Tele button<br>3\. Start the conversation with bot                                                                                              | Bot responds with "Welcome back!" for repeat users<br><br>Bot responds with "Welcome to BBDC Telebot!" for first time users                                                                           | Pass   |
| 10 |                | User can retrieve upcoming bookings                   | 1\. Send "/bookings" command to bot<br>2\. Create a new booking in the web portal.<br>3\. Resend "/bookings" command.                                                                                    | Bot replies a full list of upcoming bookings.<br><br>New booking should be reflected in second message.                                                                                               | Pass   |
| 11 |                | User can set reminders on                             | 1\. Send "/reminders" command to bot<br>2\. Click on "Enable reminders" inline keyboard button                                                                                                           | Bot replies saying reminders are on.<br><br>Database stores that reminders are on                                                                                                                     | Pass   |
| 12 |                | User can set reminders off                            | 1\. Send "/reminders" command to bot<br>2\. Click on "disable reminders" inline keyboard button                                                                                                          | Bot replies saying reminders are off.<br><br>Database stores that reminders are off.                                                                                                                  | Pass   |
| 13 |                | User can receive reminders at midnight                | 1\. Set reminder to on<br>2\. Check that upcoming booking is made<br>3\. Wait till 1 am                                                                                                                  | Bot sends reminder message to user.                                                                                                                                                                   | Pass   |
| 14 | Forum          | User can create account on forum                      | 1\. Log in and go to Forum via navbar<br>2\. Click on "Sign up"<br>3\. Fill in required particulars<br>                                                                                                  | User will successfully create a Tribe account.                                                                                                                                                        | Pass   |
| 15 |                | User can create forum post                            | 1\. Log in and go to forum via navbar<br>2\. Sign in to Tribe platform if you have not<br>3\. Type your comments into the text box at the top of the webpage with placeholder "What's on your mind?"<br> | User will successfully upload a post that is visible to all.                                                                                                                                          | Pass   |
| 16 |                | User can comment on other users' forum post           | 1\. Log in and go to forum via navbar<br>2\. Sign in to Tribe platform if you have not<br>3\. Type your comments into the text box with placeholder "What are your thoughts"<br>                         | User will successfully upload a comment that is visible to all.                                                                                                                                       | Pass   |
| 17 | Booking        | User can make a booking                               | 1\. Log in and go to Booking via Navbar<br>2\. Select the desired booking type through the 3 drop down menus<br>3\. Select the time and date<br>4\. Click confirm<br>                                    | User will be redirected to booking.html<br><br>User will be redirected to datetimeselect.html<br><br>Database will be updated with new booking details<br><br>index.html will reflect the new booking | Pass   |
